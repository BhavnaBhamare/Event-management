...
<%
   ...
   List<Booking> ae=bl.serachbookinglist();
					...
					<table data-toggle="table" data-url="tables/data1.json"
						...
						<thead>
							<tr>
								...
								<th data-field="id6" data-sortable="true">Accept</th>
						...
						<td data-field="id6" data-sortable="true"><a href="AcceptUserRequest?bid=${l.bid}" style="color: #30a5ff;" >Accept</a></td>
