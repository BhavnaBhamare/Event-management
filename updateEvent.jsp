		...
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="form-horizontal" action="UpdateEvent"
						...
						<fieldset>
							...
							<div class="form-group">
								<label class="col-md-3 control-label" for="name">Event
									Name</label>
								<div class="col-md-6">
									<input id="name" name="ename" type="text" value="${event.eventname}"
										class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input id="name" name="cost" type="text" value="${event.cost}"
										class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<input id="name" name="facility" type="text" value="${event.facility}"
										 class="form-control">
								</div>
							</div>
							...
							<div class="col-sm-04">
								<div class="form-group">
									<div class="col-md-6 widget-right">
										<button type="submit"
											class="btn btn-default btn-md pull-right">Update Event</button>
									</div>
								</div>
							</div>
